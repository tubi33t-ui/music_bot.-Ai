...
async def start(update, context):
    await update.message.reply_text("🎵 *SoundCloud Бот*\nПросто напиши название песни или исполнителя!", parse_mode='Markdown')
...
async def handle_message(update, context):
    ...
    if not results:
        await msg.edit_text(f"❌ Ничего не найдено на SoundCloud по запросу *{query}*.", parse_mode='Markdown')
        return
